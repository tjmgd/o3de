...
AZ_GFX_FLOAT_PARAM(Threshold, m_threshold, FilmGrain::DefaultThreshold)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(float, Threshold, m_threshold)

// Soft knee value for smooth threshold falloff
AZ_GFX_FLOAT_PARAM(Knee, m_knee, FilmGrain::DefaultKnee)
...
AZ_GFX_BOOL_PARAM(BicubicEnabled, m_enableBicubic, FilmGrain::DefaultEnableBicubicFilter)
AZ_GFX_ANY_PARAM_BOOL_OVERRIDE(bool, BicubicEnabled, m_enableBicubic)

AZ_GFX_FLOAT_PARAM(KernelSizeScale, m_kernelSizeScale, FilmGrain::DefaultKernelSizeScale)
...
AZ_GFX_FLOAT_PARAM(KernelSizeStage0, m_kernelSizeStage0, FilmGrain::DefaultScreenPercentStage0)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(float, KernelSizeStage0, m_kernelSizeStage0)
AZ_GFX_FLOAT_PARAM(KernelSizeStage1, m_kernelSizeStage1, FilmGrain::DefaultScreenPercentStage1)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(float, KernelSizeStage1, m_kernelSizeStage1)
AZ_GFX_FLOAT_PARAM(KernelSizeStage2, m_kernelSizeStage2, FilmGrain::DefaultScreenPercentStage2)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(float, KernelSizeStage2, m_kernelSizeStage2)
AZ_GFX_FLOAT_PARAM(KernelSizeStage3, m_kernelSizeStage3, FilmGrain::DefaultScreenPercentStage3)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(float, KernelSizeStage3, m_kernelSizeStage3)
AZ_GFX_FLOAT_PARAM(KernelSizeStage4, m_kernelSizeStage4, FilmGrain::DefaultScreenPercentStage4)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(float, KernelSizeStage4, m_kernelSizeStage4)

// Tint color for each downsample stage
AZ_GFX_VEC3_PARAM(TintStage0, m_tintStage0, FilmGrain::DefaultTint)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(AZ::Vector3, TintStage0, m_tintStage0)
AZ_GFX_VEC3_PARAM(TintStage1, m_tintStage1, FilmGrain::DefaultTint)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(AZ::Vector3, TintStage1, m_tintStage1)
AZ_GFX_VEC3_PARAM(TintStage2, m_tintStage2, FilmGrain::DefaultTint)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(AZ::Vector3, TintStage2, m_tintStage2)
AZ_GFX_VEC3_PARAM(TintStage3, m_tintStage3, FilmGrain::DefaultTint)
AZ_GFX_FLOAT_PARAM_FLOAT_OVERRIDE(AZ::Vector3, TintStage3, m_tintStage3)
AZ_GFX_VEC3_PARAM(TintStage4, m_tintStage4, FilmGrain::DefaultTint)
